...
#if LV_USE_FS_POSIX
    #define LV_FS_POSIX_LETTER 'D'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
...
#if LV_USE_FS_WIN32
    #define LV_FS_WIN32_LETTER '/'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
